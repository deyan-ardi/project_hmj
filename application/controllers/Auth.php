...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		if (!$this->ion_auth->logged_in() || !$this->ion_auth->in_group(group)) {
			...
			if ($this->ion_auth->logged_in() && $this->ion_auth->in_group(evoting)) {
				redirect('http://localhost/project_siap/project/auth/login', 'refresh');
			}
	...
	public function login()
	{
		...
		} else if ($this->ion_auth->logged_in() && $this->ion_auth->in_group(evoting)) {
			redirect('http://localhost/project_siap/project/auth/login', 'refresh');
		} else {

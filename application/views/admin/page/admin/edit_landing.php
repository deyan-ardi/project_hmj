...
<div class="container-fluid">
	...
	<p class="mb-4">Untuk menambah informasi Icon/Links yang akan ditampilkan di landing page, silahkan Edit pada form berikut</p>
	<!-- Kepengurusan -->
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<input type="text" class="form-control form-control-user" id="title" aria-describedby="title" placeholder="Masukkan Title Dari Icon/Link" name="title" value="<?= $landing[0]['title'] ?>">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<input type="text" class="form-control form-control-user" id="icon" aria-describedby="icon" placeholder="Masukkan Class Icon Font Awesome (ex. fas fa-boxes)" value="<?= $landing[0]['icon'] ?>" name="icon">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<input type="text" class="form-control form-control-user" id="link" aria-describedby="links" placeholder="Masukkan Link Kemana Akan Dituju Tanpa Base_Url (ex. beranda)" name="links" value="<?= $landing[0]['href'] ?>">
											</div>
										</div>
									</div>
								</div>

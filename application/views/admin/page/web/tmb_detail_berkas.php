									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<input type="text" class="form-control form-control-user" id="nama_berkas" aria-describedby="Berkas" placeholder="Masukkan Nama Berkas HMJ" name="nama_berkas">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<textarea type="text" id="bidang" rows="5" name="deskripsi_detail"></textarea>
											</div>
										</div>
									</div>
								</div>

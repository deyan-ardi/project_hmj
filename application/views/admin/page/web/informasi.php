 ...
 <div class="container-fluid">
 	...
 	<p class="mb-4">Untuk mengupload informasi baik itu pengumuman, berita, dan karya tulis, silahkan pilih tombol tambah data. Untuk menghapus silahkan pilih tombol delete. Data paling terbaru ada dipaling awal</p>
 	<!-- Kepengurusan -->
 	...
 	<div class="card shadow mb-4">
 		...
 		<div class="collapse show" id="kepengurusan">
 			<div class="card-body">
 				<a href="<?= base_url() ?>web/tambah_data_informasi" class="btn btn-primary btn-sm btn-icon-split mb-4">
 						...
 						<tbody>
 							<?php foreach ($informasi as $data) : ?>
 								<tr>
 									...
 									<td>
 										<a href="<?= base_url() ?>web/lihat_informasi/<?= $data['id_informasi']; ?>" class="btn btn-primary btn-sm btn-icon-split">
 											<span class="icon text-white-50">

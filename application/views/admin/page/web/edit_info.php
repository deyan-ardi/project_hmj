									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<select name="nama_kepengurusan" id="nama_kepengurusan" class="form-control form-control-select" aria-describedby="emailHelp" aria-placeholder="Masukkan Bidang HMJ">
													...
													<?php foreach ($kepengurusan as $data) : ?>
														<?php if ($select_kepengurusan[0]['status_pakai'] == $data['status_pakai']) { ?>
															<option value="<?= $data['id_hmj'] ?>" selected><?= $data['nama_hmj'] ?></option>
														<?php } else { ?>
															<option value="<?= $data['id_hmj'] ?>"><?= $data['nama_hmj'] ?></option>
														<?php } ?>
													<?php endforeach ?>
												</select>
											</div>

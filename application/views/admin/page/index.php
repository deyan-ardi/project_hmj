...
<div class="container-fluid">
						...
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Waktu dan Tanggal
								<div class="col-auto col-12 row">
									<div class="h5 mb-0 mr-2 text-xs font-weight-bold text-gray-800"><?= date("d, M Y") ?></div>
								</div>
								<div class="col-auto col-12 row">
	...
	<div class="card shadow mb-4">
		...
		<a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
			<h6 class="m-0 font-weight-bold text-primary">Selamat Datang User <?= ucfirst($group[0]['first_name']); ?> </h6>
		</a>
		...
		<div class="collapse show" id="collapseCardExample">
			<div class="card-body">
				...
				<ul>
					...
					<li>NIM Anda Adalah <span class="m-0 font-weight-bold text-primary"><?= ucfirst($group[0]['last_name']); ?></span></li>
					<li>No Telepon/WA Anda Adalah <span class="m-0 font-weight-bold text-primary"><?= ucfirst($group[0]['phone']); ?></span></li>
					<li>Anda Login Sebagai <span class="m-0 font-weight-bold text-primary"><?= ucfirst($group[0]['company']); ?></span></li>
				</ul>

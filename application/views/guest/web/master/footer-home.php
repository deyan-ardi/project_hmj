				...
				<div class="col-12 col-sm-6 col-lg-3">
					...
					<div class="footer-items">
						...
						<div class="navbar-brand">
							<img class="logo" src="<?= base_url() ?>assets/img/logo/UNDIKSHA.png" alt="Logo HMJ TI" style="height: 4.8rem;" />
							<img class="logo" src="<?= base_url() ?>assets/img/logo/HMJ.png" alt="Logo HMJ TI" style="height: 4.8rem;" />
						</div>
						<p class="mt-2 mb-3">
						...
						<div class="social-icons d-flex">
							<a class="facebook" href="https://web.facebook.com/hmj.ti.undiksha/?_rdc=1&_rdr" target="_blank">
							...
							<a class="google-plus" href="https://www.youtube.com/channel/UCjvKksTEifUWNU_rfCHubDg?app=desktop" target="_blank">

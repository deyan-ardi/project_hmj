				...
				<div class="col-12 col-md-6 col-lg-4">
					...
					<div class="single-blog res-margin">
						...
						<div class="blog-thumb">
							<img src="<?= base_url() ?>assets/upload/Folder_informasi/foto/<?= $data['foto1_informasi'] ?>" alt="">
						</div>
						<!-- Blog Content -->
						<div class="blog-content p-4">
							...
							<a href="<?= base_url() ?>web/detail_pengumuman/<?= $data['id_informasi'] ?>" class="blog-btn mt-3">Read More</a>
						</div>
					</div>
				</div>
			<?php endforeach; ?>

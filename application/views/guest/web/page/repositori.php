			...
			<div class="col-12 col-md-5 col-lg-6">
				...
				<div class="col-12 col-md-5 col-lg-6">
					...
					<div class="welcome-thumb mx-auto" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
						<img src="<?= base_url() ?>assets/img/maskot/repository.png" class="h-100 mw-auto" style="max-width: unset; margin-left: -50px;" alt="Maskot TI" />
					</div>
				</div>
			</div>
		</div>
...
<section id="features" class="section features-area style-two overflow-hidden
	...
	<div class="container">
		...
		<?php foreach ($kepengurusans as $kepengurusan):?>
			<div class="col-12 col-md-6 col-lg-3 res-margin mb-4">
				<!-- Image Box -->
				<div class="image-box text-center icon-1 p-5 wow fadeInLeft" data-wow-delay="0.4s">
					...
					<div class="icon-text">
						...
						<a href="<?= base_url() ?>web/kegiatan/<?= $kepengurusan['id_hmj'];?>" class="btn btn-bordered mt-3">Show More</a>
					</div>
				</div>
			</div>
		<?php endforeach;?>

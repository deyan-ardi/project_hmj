			...
			<div class="col-12 col-md-10 col-lg-7">
				...
				<div class="section-heading text-center">
					...
					<div class="input-group mb-3 mt-5">
						<input type="text" class="form-control" placeholder="Masukan nama kegiatan" aria-label="Recipient's username" aria-describedby="button-addon2" id="search-addon2" />
					...
					<div class="single-review card">
						...
						<div class="card-top p-4">
							...
							<div class="review-text">
								...
								<a href="<?= base_url() ?>web/detail_kegiatan/<?= $kegiatan['id_kegiatan_hmj']; ?>" class="btn btn-bordered mt-3">Lihat Detail</a>
							</div>
							<!-- Quotation Icon -->
							<div class="quot-icon">

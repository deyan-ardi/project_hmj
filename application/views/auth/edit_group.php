				...
				<div class="col-lg-6 col-md-8">
					<form class="user" action="<?= current_url() ?>" method="post">
						<div class="form-group">
							<input type="text" class="form-control form-control-user" id="group_name" aria-describedby="emailHelp" placeholder="Masukkan Nama Level User" name="group_name" value="<?= $group_name['value'] ?>">
						</div>
						<div class="form-group">
							<input type="text" class="form-control form-control-user" id="group_description" aria-describedby="emailHelp" placeholder="Masukkan Deskripsi Level User" name="group_description" value="<?= $group_description['value'] ?>">
						</div>

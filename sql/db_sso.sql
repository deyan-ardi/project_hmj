...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2020 at 06:51 AM
...
(7, 4, 'adfadf', '13:35', '16:35', 'sfaasdf', '2020-10-04 10:36:04', 'Admin');
...
(10, 19, 'sdfdsfds', 'd0186492f7efa865b112289674f7e60c.PNG', 'xcvxcv', '2020-10-04 10:45:50', 'Admin');
...
INSERT INTO `s3_lomba_integer` (`id_lomba_integer`, `id_kategori_lomba_integer`, `nama_lomba_integer`, `deskripsi_lomba_integer`, `icon_lomba_integer`, `pendaftaran_lomba_integer`, `create_at`, `create_by`) VALUES
(8, 10, 'sdfdsf', 'sdfsdf', '9e4975ba6c5bdc7be81547429f79523b.PNG', 'sdfdsf', '2020-10-04 10:46:02', 'Admin');
...
--
ALTER TABLE `s3_detail_hari_integer`
  MODIFY `id_detail_hari_integer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `s3_lomba_integer`
  MODIFY `id_lomba_integer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
